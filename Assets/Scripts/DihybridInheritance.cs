...
public class DihybridInheritance : IBreedingStrategy
{
    public Creature Breed(Creature p1, Creature p2)
    {
        ...
        if (p1.Genes.TryGetValue(Gene.Traits.CoatColor, out Gene coat1) &&
            p2.Genes.TryGetValue(Gene.Traits.CoatColor, out Gene coat2))
        {
        ...
        if (p1.Genes.TryGetValue(Gene.Traits.TailLength, out Gene tail1) &&
            p2.Genes.TryGetValue(Gene.Traits.TailLength, out Gene tail2))
        {
